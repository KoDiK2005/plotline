...
- [Vitest](https://vitest.dev/) + Testing Library для модульных тестов: 118 тестов — чистая логика движка (`engine/`) и поведение экранов (`screens/`) и компонентов через рендеринг и пользовательские взаимодействия (`@testing-library/user-event`)
